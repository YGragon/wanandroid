...
/**
 * Created by macmini002 on 18/5/30.
 */

public class DampingScollerView extends ScrollView {
    ...
    public DampingScollerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

    }

    public DampingScollerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mScroller = new Scroller(context);
    }

    public DampingScollerView(Context context) {
        super(context);
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            int scrollY = DampingScollerView.this.getScrollY();
