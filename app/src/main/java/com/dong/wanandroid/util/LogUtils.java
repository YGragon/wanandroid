...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = BaseApplication.getAppContext()
                    .getPackageManager()
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && BaseApplication.getAppContext().getExternalCacheDir() != null)
                mDefaultDir = BaseApplication.getAppContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = BaseApplication.getAppContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
