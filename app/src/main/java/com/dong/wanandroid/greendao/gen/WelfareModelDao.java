...
/** 
 * DAO for table "WELFARE_MODEL".
*/
public class WelfareModelDao extends AbstractDao<WelfareModel, Void> {

    public static final String TABLENAME = "WELFARE_MODEL";

    /**
     * Properties of entity WelfareModel.<br/>
    ...
    public WelfareModelDao(DaoConfig config) {
        super(config);
    }
    
    public WelfareModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WELFARE_MODEL\" (" + //
                "\"_ID\" TEXT," + // 0: _id
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WELFARE_MODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, WelfareModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, WelfareModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public WelfareModel readEntity(Cursor cursor, int offset) {
        WelfareModel entity = new WelfareModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, WelfareModel entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(WelfareModel entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(WelfareModel entity) {
        return null;
    }

    @Override
    public boolean hasKey(WelfareModel entity) {
        // TODO
        return false;
    }
